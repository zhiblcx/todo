...
function Increase() {
  ...
  const varValue = styles.getPropertyValue('--addTask--content').slice(1, styles.getPropertyValue('--addTask--content').length - 1)
  const customStyle = {
  ...
  return (
    <div>
      ...
      <div className="box">
        <TaskBox taskName={taskName} label={label} focusInput={focusInput} blurInput={blurInput} customStyle={customStyle} />
